...
private fun VectorPreview() {
    Image(ProfileOutlined, null)
}

private var profileOutlined: ImageVector? = null

public val ProfileOutlined: ImageVector
    get() {
        if (profileOutlined != null) {
            return profileOutlined!!
        }
        profileOutlined = ImageVector.Builder(
